...
public class TextInputFile {
	...
	public TextInputFile(String fileName) {
		if (fileName.equalsIgnoreCase("standard input") || fileName.equalsIgnoreCase("keyboard")
	...
	/**
	 * Read an 8-bit integer (a "byte") from the file. The actual text in the file
	 * must be a number from -128 to 127.
	 *
	...
	/**
	 * Read a 32-bit integer (an "int") from the file. The actual text in the file
	 * must be a number from -2147483648 to 2147483647.
	 *
	...
	/**
	 * Read a 16-bit integer (a "short") from the file. The actual text in the file
	 * must be a number from -32768 to 32767.
	 *
