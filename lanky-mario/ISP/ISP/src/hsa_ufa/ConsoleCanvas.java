...
public class ConsoleCanvas extends JPanel implements ActionListener, KeyListener {
	 ...
	 * whitespace. If you want to get every character on the line, use the readLine
	 * () method.
	 *
	 ...
	 * can't be a problem with input being taken off the keyboard buffer and placed
	 * on the keyboard buffer at the same time. Adapted from hsa. Modified by Sam to
	 * record the current key held down.
	 */
	...
	/**
	 * Draws the specified text to the screen at the specified row and column using
	 * the specified foreground and background colours. Adapted from hsa.
	 */
	...
	/**
	 * Clears a rectangle on console canvas from the specified row and column to the
	 * end of line. Adapted from hsa.
	 */
