...
public class TextOutputFile {
	...
	public TextOutputFile(String fileName, boolean append) {
		if (fileName.equalsIgnoreCase("standard output") || fileName.equalsIgnoreCase("screen")
	...
	/**
	 * Write the text representation of an 8-bit integer (a "byte") to the file with
	 * a specified field size.
	 *
	 * @param number
	 *            The number to be written to the file.
	 * @param fieldSize
	...
	/**
	 * Write a double precision floating point number (a "double") to the file with
	 * a specified field size.
	 *
	 * @param number
	 *            The number to be written to the file.
	...
	/**
	 * Write a floating point number (a "float") to the file with a specified field
	 * size.
	 *
	 * @param number
	 *            The number to be written to the file.
	...
	/**
	 * Write a floating point number (a "double") to the file with a specified field
	 * size and a specified number of decimal places.
	 *
	 * @param number
	 *            The number to be written to the file.
	 * @param fieldSize
	...
	/**
	 * Write the text representation of a boolean to the file with a specified field
	 * size.
	 *
	 * @param value
	 *            The boolean to be written to the file.
	...
	/**
	 * Write a double precision floating point number (a "double") to the file with
	 * a specified field size and a specified number of decimal places followed by a
	 * newline.
	 *
	 * @param number
	 *            The number to be written to the file.
	...
	/**
	 * Write a floating point number (a "double") to the file with a specified field
	 * size and a specified number of decimal places followed by a newline.
	 *
	 * @param number
	 *            The number to be written to the file.
	 * @param fieldSize
