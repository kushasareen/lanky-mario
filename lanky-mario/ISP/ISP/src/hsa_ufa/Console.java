...
public class Console extends JFrame implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	/**
	 * NOTE: This command only sets the background color. Nothing will change on the
	 * drawing surface until you use clearRect() or clear()
	 * 
	 * @param c
	...
	/**
	 * Sets XOR painting mode. In this mode, every pixel drawn to the screen will be
	 * combined with the pixel already on the screen to create an "outline" effect
	 * of what was beneath it. In this mode, if you draw the same object twice in
	 * the same location, it will appear and then disappear. See also
	 * setPaintMode().
	 * 
	 * @param c
	 *            Color to use as the background color for computation of new color
	 */
	...
	/**
	 * Draws an arc outline on the drawing area. The arc will be inscribed within a
	 * rectangle, just like drawOval(), but only part of the oval will be drawn.
	 * Draws an oval outline on the drawing area, inscribed within a rectangle.
	 * 
	 * @param x
	 *            Top left X coordinate of the rectangle
	 ...
	 * @param startAngle
	 *            Start angle of arc in degrees (0 = right middle, 90 = top middle,
	 *            etc.)
	 * @param arcAngle
	...
	/**
	 * Draws a filled in arc outline on the drawing area (looks like a pie slice).
	 * The arc will be inscribed within a rectangle, just like drawOval(), but only
	 * part of the oval will be drawn. Draws an oval outline on the drawing area,
	 * inscribed within a rectangle.
	 * 
	 * @param x
	 *            Top left X coordinate of the rectangle
	 * @param y
	 ...
	 * that the coordinates specify the bottom left corner rather than the top left
	 * corner for drawing.
	 * 
	 * @param str
	 *            The string to draw.
	 ...
	 * while to load, this method will delay until it is loaded, timing out after
	 * 1000 ms.
	 * 
	 * @param img
	 *            The image to draw
	 ...
	 *
	 * @param x
	 *            The x coordinate of the top left corner of the rectangle that the
	 *            star is inscribed in.
	 * @param y
	 *            The y coordinate of the top left corner of the rectangle that the
	 *            star is inscribed in.
	 * @param width
	 ...
	 *            maple leaf is inscribed in.
	 * @param width
	 *            The width of the rectangle that the maple leaf is inscribed in.
	 * @param height
	 ...
	 *
	 * @param x
	 *            int The x coordinate of the top left corner of the rectangle that
	 *            the maple leaf is inscribed in.
	 * @param y
	 *            int The y coordinate of the top left corner of the rectangle that
	 *            the maple leaf is inscribed in.
	 * @param width
	 *            int The width of the rectangle that the maple leaf is inscribed
	 *            in.
	 * @param height
	 *            int The height of the rectangle that the maple leaf is inscribed
	 *            in.
	 */
	...
	/**
	 * Writes the text representation of an 8-bit integer (a "byte") to the Console
	 * with a specified field size followed by a newline. Adapted from hsa.
	 * 
	 * @param number
	 *            The number to be written to the Console.
	 * @param fieldSize
	...
	/**
	 * Writes a character to the Console with a specified field size. Adapted from
	 * hsa.
	 *
	 * @param ch
	 *            The character to be written to the Console.
	...
	/**
	 * Writes a double precision floating point number (a "double") to the Console
	 * with a specified field size and a specified number of decimal places followed
	...
	/**
	 * Writes a floating point number (a "float") to the Console with a specified
	 * field size followed by a newline. Adapted from hsa.
	 *
	 * @param number
	 *            The number to be written to the Console.
	 * @param fieldSize
	...
	/**
	 * Writes a floating point number (a "double") to the Console with a specified
	 * field size and a specified number of decimal places followed by a newline.
	 * Adapted from hsa.
	 *
	 * @param number
	 *            The number to be written to the Console.
	...
	/**
	 * Writes the text representation of an 8-bit integer (a "byte") to the Console
	 * with a specified field size. Adapted from hsa.
	 *
	 * @param number
	 *            The number to be written to the Console.
	 * @param fieldSize
	...
	/**
	 * Writes a double precision floating point number (a "double") to the Console
	 * with a specified field size and a specified number of decimal places. Adapted
	 * from hsa.
	 *
	 * @param number
	 *            The number to be written to the Console.
	...
	/**
	 * Writes a floating point number (a "double") to the Console with a specified
	 * field size and a specified number of decimal places. Adapted from hsa.
	 * 
	 * @param number
	 *            The number to be written to the Console.
	 * @param fieldSize
	...
	/**
	 * Writes the text representation of a boolean to the Console with a specified
	 * field size. Adapted from hsa.
	 *
	 * @param value
	 *            The boolean to be written to the Console.
	 * @param fieldSize
	...
	/**
	 * Writes the text representation of an 16-bit integer (a "short") to the
	 * Console with a specified field size followed by a newline. Adapted from hsa.
	 * 
	 * @param number
	 *            The number to be written to the Console.
	 * @param fieldSize
	...
	/**
	 * Reads an 8-bit integer (a "byte") from the Console. The actual text in the
	...
	/**
	 * Reads a 32-bit integer (an "int") from the Console. The actual text in the
	...
	/**
	 * Reads a 16-bit integer (a "short") from the Console. The actual text in the
	 * Console must be a number from -32768 to 32767.
	 *
	...
	/*
	 * The enableMouse... methods are included so that the overhead of listening for
	 * mouse events is not a factor if the programmer doesn't want to use the mouse.
	 * 
	 * You MUST invoke the appropriate enableMouse... methods() first, if you want
	 * to use the mouse.
	 * 
	 ...
	 * getMouseX() and getMouseY() return the coordinates of the mouse as of the
	 * last time a button was clicked/pressed/released.
	 * 
	 * - getMouseButton() and getMouseClick() are enabled.
	 * 
	 * enableMouseMotion(): Listens for mouse move and drag events, thereby allowing
	 * getMouseX() and getMouseY() to return the current coordinates of the mouse,
	 * regardless of button or wheel events.
	 * 
	 * enableMouseWheel(): Listens for mouse wheel events, and also saves the
	 * coordinates of the mouse when a mouse wheel event occurs, so that getMouseX()
	 * and getMouseY() return the coordinates of the mouse as of the last time the
	 ...
	 * getMouseY() will return the current coordinates of the mouse, rather than the
	 * coordinates of the mouse as of the last time a button was
	 * clicked/pressed/released or wheel was scrolled.
	 * 
	 * enableMouseMotion() is by far the most demanding in terms of overhead, so
	 * don't invoke this method unless it is absolutely necessary.
	 * 
	 * disableMouse... methods are provided to avoid mouse event overhead when they
	...
	/*
	 * Returns non-zero if the mouse has been clicked since the last time the click
	 * was queried, zero if the mouse was not clicked.
	 * 
	...
	/*
	 * Returns the number of units the mouse wheel has been scrolled since the last
	 * time the wheel was queried.
	 */
