...
class CloseableDialog extends java.awt.Dialog implements java.awt.event.ActionListener, java.awt.event.WindowListener {
	...
	/**
	 * Places the dialog in the centre of the window passed in, or in the centre of
	 * the screen if no window is provided.
	 *
	 * @param window
	...
	public void positionDialog(java.awt.Window window) {
		...
		if (window == null) {
			...
			loc = new java.awt.Point(windowLoc.x + (windowSize.width - dlgSize.width) / 2,
	...
	/**
	 * Does nothing. Called by the system after the dialog has been closed (dispose
	 * () has been called).
	 *
	 * @param e
	 *            The window event
	...
	/**
	 * Closes the dialog. Called by the system when the close box of the dialog has
	 * been clicked.
	 *
	 * @param e
	 *            The window event
	...
	/**
	 * Does nothing. Called by the system after the dialog has been opened for the
	 * first time.
	 *
	 * @param e
	 *            The window event
